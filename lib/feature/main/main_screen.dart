...
class MainScreen extends StatefulWidget {
  ...
  const MainScreen({Key? key, required this.focusNodes}) : super(key: key);
      ...
      drawer: Drawer(
        child: ListView(
          children: [
            ...
            //       if (onboarding != null) {
            //         onboarding.showFromIndex(1);
            //       }
            //       Navigator.of(context).push(MaterialPageRoute(
            //           builder: (context) => HomeScreen(focusNodes: widget.focusNodes)));
            //     },
    ...
    switch (_mainBloc.state.index) {
      case 0:
        return _mainBloc.state.defaultVersion
            ? HomeScreen(focusNodes: widget.focusNodes)
